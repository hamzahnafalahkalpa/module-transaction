...
use Zahzah\ModuleTransaction\Concerns\{
    HasInvoice
};
use Zahzah\ModuleTransaction\Enums\Transaction\TransactionStatus;
use Zahzah\ModuleTransaction\Resources\Transaction\{
    ShowTransaction, ViewTransaction
};
...
class Transaction extends BaseModel{
    ...
    protected $list       = [
        'id','uuid','transaction_code','reference_type','reference_id','status',
        'created_at','reported_at','canceled_at'
    ];
