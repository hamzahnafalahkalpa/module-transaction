...
use Zahzah\ModuleTransaction\Resources\Invoice\ShowInvoice;
use Zahzah\ModuleTransaction\Resources\Invoice\ViewInvoice;
...
class Invoice extends BaseModel{
    ...
    protected $list       = [
        'id','author_id', 'author_type', 'consument_id', 'consument_type',
        'paid_at', 'generated_at', 'billing_at', 'props'
    ];
...
//    public function transactions(){return $this->hasManyModel('Transaction');}
    public function transactionBillingDeferred(){return $this->hasOneModel('Transaction','reference_id','id')->where('reference_type',$this->BillingDeferredModelMorph());}
}
