...
use Zahzah\ModuleTransaction\Contracts\PaymentSummary as ContractsPaymentSummary;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Collection;
use Illuminate\Pagination\LengthAwarePaginator;
use Zahzah\ModuleTransaction\Resources\PaymentSummary\{
    ShowPaymentSummary, ViewPaymentSummary
};

class PaymentSummary extends PackageManagement implements ContractsPaymentSummary{
    protected array $__guard   = [
        'id', 'parent_id', 'transaction_id',
        'reference_id','reference_type','payment_history_id'
    ]; 
    protected array $__add     = [
        'total_amount','total_debt','total_discount',
        'total_tax','total_additional'
    ];
